...
[앞 글](/posts/release-train-scrum/)에서 열차 체계를 설계했다. 그 설계를 Jira에 옮기는 순간 첫 오해가 드러났다 — 버전 항목이 80개 넘게 난립해 있었고, 릴리스 대상 티켓 53건은 어느 보드에도 제대로 모여 있지 않았다. 전환 전에는 "릴리스 묶음"과 "QA"를 각각 **에픽**으로 만들어 관리하고 있었다.
