...
운영 규모는 글로벌 고객사 10곳 이상, 현장 장비 수십 대, 최근 6개월 기준 현장 알림 3,493건(전부가 장애는 아니다)이다. 그 와중에 한 고객사가 "장애가 나도 follow-up과 원인 공유(RCA)가 없다"고 공식 컴플레인을 제기했다. 이 컴플레인을 계기로 장애 대응 프로세스를 표준화했다. 핵심은 **"무엇을 고쳐주고 앞으로 무엇을 더 하는지"를 고객이 한눈에 보게 하는 것**.
