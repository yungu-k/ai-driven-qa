...
[운영 이슈 트리아지 자동화](/posts/live-issue-triage)로 알람 분류와 리포트는 자동화했지만, 한계가 있었다. **사후적이고 정적이었다** — 배포 주기마다 한 번, 미팅 자리에서만 펼쳐 봤고, 정작 현장에서 장비가 멈추는 그 순간은 아무도 실시간으로 보지 못했다. 현장은 하루 평균 30건 안팎의 알람을 쏟아내는데, '지금 몇 번 장비가 어떤 상태인가'를 상시 보여주는 살아있는 화면이 없었다.
